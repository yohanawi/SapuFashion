...
<body> 
    ...
    <section class="products shopping-cart">
        ...
        <div class="row_cart">
            <div class="cart-total" style="padding-right: 50px;">
                <p>Subtotal : <span style="padding-left: 140px;">Rs.<?= $grand_total; ?>/-</span></p>
                <p>Shipping : <span style="padding-left: 138px;">Rs.<?= $shipping; ?>/-</span></p>  
                <p>Total : <span style="padding-left: 170px;">Rs.<?= $totals; ?>/-</span></p>
            </div>
